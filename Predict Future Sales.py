...
# df_items.head()
# df_submit.head()
df_train.columns = np.array(['date','date_block_num','shop_id','item_id','item_price','item_cnt_day'])
df_test.columns = np.array(['ID','shop_id','item_id'])
df_items.columns = np.array(['item_name','item_id','item_category_id'])
df_submit.columns = np.array(['ID','item_cnt_month'])
#print(df_items.head())
